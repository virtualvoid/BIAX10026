...
\subsection*{Porovnávacia analýza alternatív}

\begin{table}[h]
\centering
\begin{tabular}{p{3.2cm} p{3.2cm} p{3.2cm} p{3.2cm}}
\toprule
\textbf{Kritérium} & \textbf{ERP riešenie} & \textbf{ECM riešenie} & \textbf{Samostatné DMS} \\
\midrule
Rozsah funkcionality & Veľmi široký & Široký & Zameraný na dokumenty \\
Implementačná náročnosť & Vysoká & Stredná až vysoká & Stredná \\
Finančná náročnosť & Vysoká & Stredná až vysoká & Primeraná \\
Čas implementácie & Dlhší (6–12 mesiacov) & 4–8 mesiacov & 4–6 mesiacov \\
Vhodnosť pre aktuálny stav podniku & Čiastočná & Čiastočná & Vysoká \\
Možnosť budúcej integrácie & Vysoká & Vysoká & Vysoká \\
\bottomrule
\end{tabular}
\caption{Porovnanie alternatív implementácie informačného riešenia}
\end{table}

\subsection*{Kritériá hodnotenia a výber riešenia}

Pri výbere vhodného informačného riešenia boli zohľadnené viaceré hodnotiace kritériá:

\begin{itemize}
    \item súlad s identifikovanými problémami podniku,
    \item celkové náklady vlastníctva (Total Cost of Ownership – TCO),
    \item implementačná náročnosť a organizačný dopad,
    \item škálovateľnosť riešenia,
    \item bezpečnostné mechanizmy a riadenie prístupových práv,
    \item možnosť budúcej integrácie v rámci \gls{pis}.
\end{itemize}

Z hľadiska celkových nákladov vlastníctva predstavuje samostatné \gls{dms} riešenie vyvážený kompromis medzi funkcionalitou a finančnou náročnosťou. 
Podniku umožňuje riešiť najkritickejšiu oblasť správy dokumentácie bez potreby rozsiahlej reorganizácie procesov alebo vysokých investičných nákladov.

Zároveň vytvára technologický základ pre budúcu integráciu s \gls{erp} alebo inými podnikovými systémami, čím podporuje postupnú a kontrolovanú digitalizáciu organizácie.
